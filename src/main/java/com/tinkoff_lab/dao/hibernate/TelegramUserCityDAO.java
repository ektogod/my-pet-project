...
public class TelegramUserCityDAO {
    SessionFactory sessionFactory;
    Logger logger = LoggerFactory.getLogger(UserCityDAO.class);
    public void addTelegramUserCity(TelegramUser user, City city) {
        logger.info("Start adding TelegramUserCity where TelegramUser: {}, City: {}", user, city);
        Session session = sessionFactory.getCurrentSession();
        try {
            TelegramUser existingUser = session.get(TelegramUser.class, user.getChatId());
    ...
    public void removeUserCity(TelegramUser user, City city) {
